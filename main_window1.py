...
def text():
        subprocess.check_call(["python", "text1copy.py"])

def image():
        subprocess.check_call(["python", "image1copy.py"])

def video():
        subprocess.check_call(["python", "video.py"])

def audio():
        subprocess.check_call(["python", "audio1copy.py"])
